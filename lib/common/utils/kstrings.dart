class AppText {
  ...
  static const String kCollection = 'Nouvelle Collection';
  ...
  static const String kViewAll = 'Tout Voir';
  static const String kFlash = 'Flash Sales';
  static const String kWishlist = 'Liste de souhaits';
  ...
  static const String kWelcomeMessage =
      ...
      "Bienvenue sur l'application de mode ! Découvrez les tendances, achetez vos styles préférés et améliorez votre garde-robe. Commençons ";
  ...
  static const String kOnboardWishListMessage =
      ...
      "Votre liste de souhaits vous attend ! Organisez vos looks de rêve et"
      " enregistrez vos favoris pour plus tard."
      " C'est la première étape pour faire de vos aspirations de style une réalité";
